                                        ...
                                        <div class='row'>
                                            ...
                                            <div class='col-sm-1'>
                                                <a href='../pages/editSportiv.php?hash=".$row['hash']."'>
                                                    <svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' id='Capa_1' x='0px' y='0px' viewBox='0 0 55.25 55.25' xml:space='preserve' class='iconList'>
                                            ...
                                            <div class='col-sm-1'>
                                                <a href='../scripts/deleteSportiv.php?hash=".$row['hash']."'>
                                                    <svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' id='Capa_1' x='0px' y='0px' viewBox='0 0 56.061 56.062' xml:space='preserve' class='iconList'>
